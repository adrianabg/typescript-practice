...
function submitWheels(){
    ...
    const wheel1 = (<HTMLInputElement>document.getElementById("wheel1")).value;
    const wheel2 = (<HTMLInputElement>document.getElementById("wheel2")).value;
    const wheel3 = (<HTMLInputElement>document.getElementById("wheel3")).value;
    const wheel4 = (<HTMLInputElement>document.getElementById("wheel4")).value;

    //Marca de les rodes
    var brandWheel1 = (<HTMLInputElement>document.getElementById("brandWheel1"));
    var brandWheel2 = (<HTMLInputElement>document.getElementById("brandWheel2"));
    var brandWheel3 = (<HTMLInputElement>document.getElementById("brandWheel3"));
    var brandWheel4 = (<HTMLInputElement>document.getElementById("brandWheel4"));
